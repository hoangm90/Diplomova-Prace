...
#####################################################################################
def create_subjects_dictionary(lesson_raw, lessons):
    subjects = {}
    subjects["no_subject"] = []
...
############################################################################################
def coloring(data, lessons):
    lessons_raw = data["events"]
    classrooms = data["classrooms"]
    teachers = data["teachers"]
    groups = data["groups"]
    subjects = create_subjects_dictionary(lessons_raw, lessons)
...
################################################################################################
def return_planned_timetables(data, les, queue):
    lessons, smallest_number_color = coloring(data, les)
    ...
    result =  [lessons_raw, smallest_number_color]
    queue.put(result)
